<div class="dashboard-main-body">
  ...
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Nova Oficina</h6>
    <ul class="d-flex align-items-center gap-2">
      ...
      <li>-</li>
      <li class="fw-medium"><a href="/teapp/oficinas">Oficinas</a></li>
      <li>-</li>
      <li class="fw-medium">Nova Oficina</li>
    </ul>
  </div>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="/teapp/oficinas/adicionarACT" method="POST">
