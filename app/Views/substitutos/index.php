                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="card-header d-flex align-items-center flex-wrap gap-2">
                            <a href="/teapp/substitutos/adicionar" class="btn btn-primary btn-sm ms-auto d-flex align-items-center gap-1 align-self-end mt-1 text-right">
                            ...
                            <tbody>
                                ...
                                if (!empty($this->dados) && is_array($this->dados)) {
                                    foreach ($this->dados as $key) {
                                        ...
                                        echo '<td class="text-center">
                                            <a href="/teapp/substitutos/editar/' . $key['id_substituto'] . '" class="btn btn-sm btn-secondary p-3 me-1" title="Editar">
                                                <iconify-icon icon="solar:pen-new-round-line-duotone" class="icon text-md"></iconify-icon>
                                            </a>
                                            <a href="/teapp/substitutos/excluir/' . $key['id_substituto'] . '" class="btn btn-sm btn-outline-secondary p-3" onclick="return confirm(\'Tem certeza que deseja desativar?\')" title="Excluir">
